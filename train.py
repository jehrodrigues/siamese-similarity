...
from data_reader import read_ASSIN_data
...
train_df, dev_df, test_df = read_ASSIN_data(args.data, True)
...
#criar o output
#write_xml('%soutput.xml' % DATA_DIR, y)
...
print('Spearmans p = %.2f' % spearmanr.correlation)